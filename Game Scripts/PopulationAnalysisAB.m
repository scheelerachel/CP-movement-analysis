...
figure
hold on
scatter(comt_d_1,comt_d_2)
scatter(comt_l_1, comt_l_2);
plot([0,max(cat(2,comt_d_1,comt_d_2))],[0,max(cat(2,comt_d_1,comt_d_2))])
title('Completion Time Comparing Visits for Dominant/Less-Affected')
xlabel('Visit 1 Completion Time')
ylabel('Visit 2 Completion Time')
hold off
...
figure
hold on
scatter(comt_n_1,comt_n_2)
scatter(comt_m_1, comt_m_2);
plot([0,max(cat(2,comt_n_1,comt_n_2))],[0,max(cat(2,comt_n_1,comt_n_2))])
title('Completion Time Comparing Visits for Non-Dominant/More-Affected')
xlabel('Visit 1 Completion Time')
ylabel('Visit 2 Completion Time')
hold off
...
figure
hold on
scatter(rms_d_1,rms_d_2)
scatter(rms_l_1, rms_l_2);
plot([0,max(cat(2,rms_d_1,rms_d_2))],[0,max(cat(2,rms_d_1,rms_d_2))])
plot([0,max(cat(2,rms_l_1,rms_l_2))],[0,max(cat(2,rms_l_1,rms_l_2))])

title('RMSE Comparing Visits for Dominant/Less-Affected')
xlabel('Visit 1 RMSE')
ylabel('Visit 2 RMSE')
hold off
...
figure
hold on
scatter(rms_n_1,rms_n_2)
scatter(rms_m_1, rms_m_2);
plot([0,max(cat(2,rms_n_1,rms_n_2))],[0,max(cat(2,rms_n_1,rms_n_2))])
plot([0,max(cat(2,rms_m_1,rms_m_2))],[0,max(cat(2,rms_m_1,rms_m_2))])

title('RMSE Comparing Visits for Non-Dominant/More-Affected')
xlabel('Visit 1 RMSE')
ylabel('Visit 2 RMSE')
hold off
...
title(t,'/Speed/(Completion Time) Accuracy Relationship for TD Cohort')

nexttile;
hold on
scatter(comt_d_1, rms_d_1);
...
nexttile;
hold on
scatter(comt_n_2, rms_n_2);
xlabel('Completion Time (s)')
ylabel('Accuracy (RMSE)')
title('Non-Dominant Visit 2')
hold off

coeff = corrcoef(comt_d_1,rms_d_1);
fprintf('ComT/Accuracy Dominant Visit 1\n')
disp(coeff)

coeff = corrcoef(comt_d_2,rms_d_2);
fprintf('ComT/Accuracy Dominant Visit 2\n')
disp(coeff)

coeff = corrcoef(comt_n_1,rms_n_1);
fprintf('ComT/Accuracy Non-Dominant Visit 1\n')
disp(coeff)

coeff = corrcoef(comt_n_2,rms_n_2);
fprintf('ComT/Accuracy Non-Dominant Visit 2\n')
disp(coeff)
