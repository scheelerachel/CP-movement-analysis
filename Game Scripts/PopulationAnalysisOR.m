...
title('Completion Time Comparing Visits for TD Dominant')
xlabel('Visit 1 Completion Time')
ylabel('Visit 2 Completion Time')
hold off

coeff = corrcoef(comt_d_1,comt_d_2);
...
title('Completion Time Comparing Visits for TD Non-Dominant')
xlabel('Visit 1 Completion Time')
ylabel('Visit 2 Completion Time')
hold off

coeff = corrcoef(comt_n_1,comt_n_2);
...
title('RMSE Comparing Visits for TD Dominant')
xlabel('Visit 1 RMSE')
ylabel('Visit 2 RMSE')
hold off

coeff = corrcoef(rms_d_1,rms_d_2);
...
title('RMSE Comparing Visits for TD Non-Dominant')
xlabel('Visit 1 RMSE')
ylabel('Visit 2 RMSE')
hold off

coeff = corrcoef(rms_n_1,rms_n_2);
